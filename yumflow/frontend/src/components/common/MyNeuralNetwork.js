...
const MyNeuralNetwork = () => {
    useEffect(() => {
        const c = document.getElementById('c')
        var w = c.width = document.getElementById('header').offsetWidth,
            h = c.height = window.innerHeight - document.getElementById('header').offsetHeight,
            ctx = c.getContext('2d'),
...
export default MyNeuralNetwork;
